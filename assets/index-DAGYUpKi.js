var e=Object.create,t=Object.defineProperty,n=Object.getOwnPropertyDescriptor,r=Object.getOwnPropertyNames,i=Object.getPrototypeOf,a=Object.prototype.hasOwnProperty,o=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),s=(e,i,o,s)=>{if(i&&typeof i==`object`||typeof i==`function`)for(var c=r(i),l=0,u=c.length,d;l<u;l++)d=c[l],!a.call(e,d)&&d!==o&&t(e,d,{get:(e=>i[e]).bind(null,d),enumerable:!(s=n(i,d))||s.enumerable});return e},c=(n,r,a)=>(a=n==null?{}:e(i(n)),s(r||!n||!n.__esModule?t(a,`default`,{value:n,enumerable:!0}):a,n));(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var l=(e,t)=>`
        ...
        <div class="footer__container">
            <div class="footer__top">
                ...
                <div class="footer__brand">
                    ...
                    <p class="footer__tagline">${e(`footer_tagline`)||`Elevating your daily ritual.<br>One cup at a time.`}</p>
    ...
    `),x=``+new URL(`logo-C2qnGzv1.jpg`,import.meta.url).href,S=(e,t)=>`
    <header class="header">
    <!-- Cafe Logo -->
    ...
    <div class="about_page dark-tech-theme">
        ...
        <section class="about-row">
            ...
            <div class="about-image fade-in-up">
                <img src="${w}" alt="Brazil Coffee Beans">
            </div>
        </section>
        ...
        <section class="about-row reverse">
            <div class="about-image fade-in-up">
                <img src="${T}" alt="Colombia Ripe Berry">
            </div>
            <div class="about-text fade-in-up">
        ...
        <section class="about-row">
            ...
            <div class="about-image fade-in-up">
                <img src="${D}" alt="Sumatra Coffee Beans">
            </div>
        </section>
        ...
        <section class="coffee-collage fade-in-up">
            ...
            <div class="collage-item center">
                <div class="collage-inner" style="background-image: url('${A}');"></div>
    ...
    `,M=``+new URL(`contacts1-DxYppO0K.jpg`,import.meta.url).href,N=``+new URL(`contacts2-nn4M6STi.jpg`,import.meta.url).href,P=e=>`
    <div class="contacts-split-page">
        <!-- Блок Praha 5 -->
        <div class="split-block praha5" style="background: linear-gradient(rgba(18, 20, 22, 0.80), rgba(18, 20, 22, 0.80)), url('${M}') center/cover no-repeat;">
        ...
        <!-- Блок Praha 3 -->
        <div class="split-block praha3" style="background: linear-gradient(rgba(18, 20, 22, 0.80), rgba(18, 20, 22, 0.80)), url('${N}') center/cover no-repeat;">
            <div class="split-content">
                <h2>PRAHA 3</h2>
                <div class="info-table">
                    <div class="info-row">
    ...
    `,F=``+new URL(`breakfast1-CCMa6iCo.jpg`,import.meta.url).href,I=``+new URL(`breakfast2-BHyXAAKk.jpg`,import.meta.url).href,L=``+new URL(`pasta1-DF6DmOcv.jpg`,import.meta.url).href,R=``+new URL(`pasta2-BZMAP7QE.jpg`,import.meta.url).href,z=``+new URL(`salads-CFEbGa0F.jpg`,import.meta.url).href,B=``+new URL(`soups-CZ_XYrJE.jpg`,import.meta.url).href,V=``+new URL(`pizza1-DnB0wuAZ.jpg`,import.meta.url).href,H=``+new URL(`pizza2-CcKfxzin.jpg`,import.meta.url).href,U=e=>`
    <div class="menu-page dark-tech-theme">
        ...
        <div class="menu-container">
            ...
            <section class="menu-section fade-in-up pizza-section" id="pizza-section">
                ...
                <div class="menu-image-card"><img src="${V}" alt="Pizza 1"></div>
                <div class="menu-image-card"><img src="${H}" alt="Pizza 2"></div>
            </section>

            <!-- Завтраки -->
            <section class="menu-section fade-in-up">
                <h2 class="section-title">${e(`menu_breakfast`)}</h2>
                <div class="menu-image-card"><img src="${F}" alt="Snídaně 1"></div>
                <div class="menu-image-card"><img src="${I}" alt="Snídaně 2"></div>
            </section>

            <!-- Паста -->
            <section class="menu-section fade-in-up">
                <h2 class="section-title">${e(`menu_pasta`)}</h2>
                <div class="menu-image-card"><img src="${L}" alt="Pasta 1"></div>
                <div class="menu-image-card"><img src="${R}" alt="Pasta 2"></div>
            </section>

            <!-- Салаты -->
            <section class="menu-section fade-in-up">
                <h2 class="section-title">${e(`menu_salads`)}</h2>
                <div class="menu-image-card"><img src="${z}" alt="Saláty"></div>
            </section>

            <!-- Супы -->
            <section class="menu-section fade-in-up">
                <h2 class="section-title">${e(`menu_soups`)}</h2>
                <div class="menu-image-card"><img src="${B}" alt="Polévky"></div>
            </section>
        </div>
    </div>
    `,W=e=>`
    ...
    `,G=``+new URL(`coffee2-DEi4WC9A.png`,import.meta.url).href,K=e=>(setTimeout(()=>{let e=document.querySelector(`.about_text`);e&&q.observe(e)},100),setTimeout(()=>{let e=document.querySelector(`.reviews`);e&&J.observe(e)},100),`
<div class="home">
        <div class="home1"> 
