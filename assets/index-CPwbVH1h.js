var e=Object.create,t=Object.defineProperty,n=Object.getOwnPropertyDescriptor,r=Object.getOwnPropertyNames,i=Object.getPrototypeOf,a=Object.prototype.hasOwnProperty,o=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),s=(e,i,o,s)=>{if(i&&typeof i==`object`||typeof i==`function`)for(var c=r(i),l=0,u=c.length,d;l<u;l++)d=c[l],!a.call(e,d)&&d!==o&&t(e,d,{get:(e=>i[e]).bind(null,d),enumerable:!(s=n(i,d))||s.enumerable});return e},c=(n,r,a)=>(a=n==null?{}:e(i(n)),s(r||!n||!n.__esModule?t(a,`default`,{value:n,enumerable:!0}):a,n));(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var l=(e,t)=>`
    ...
    `,C=`/duo_cafe/assets/brazil-map-bean-CUAcD6uv.jpg`,w=`/duo_cafe/assets/columbia-ripe-berry-Di5i5roE.jpg`,T=`/duo_cafe/assets/hero-Dg5suEkF.jpg`,E=e=>`
    <div class="about_page dark-tech-theme">
        ...
        <section class="about-hero" style="background-image: url('${T}');">
            ...
            <div class="hero-content fade-in-up">
                <h1>${e(`about_hero_title`)}</h1>
                <p>${e(`about_hero_subtitle`)}</p>
            </div>
        </section>
        ...
        <section class="about-row">
            <div class="about-text fade-in-up">
                <h2>${e(`about_brazil_title`)}</h2>
                <p>${e(`about_brazil_text`)}</p>
            </div>
        ...
        <section class="about-row reverse">
            ...
            <div class="about-text fade-in-up">
                <h2>${e(`about_columbia_title`)}</h2>
                <p>${e(`about_columbia_text`)}</p>
            </div>
        </section>
    ...
    `,D=`/duo_cafe/assets/contacts1-DxYppO0K.jpg`,O=`/duo_cafe/assets/contacts2-nn4M6STi.jpg`,k=e=>`
    <div class="contacts-split-page">
        <!-- Блок Praha 5 -->
        <div class="split-block praha5" style="background: linear-gradient(rgba(18, 20, 22, 0.80), rgba(18, 20, 22, 0.80)), url('${D}') center/cover no-repeat;">
        ...
        <!-- Блок Praha 3 -->
        <div class="split-block praha3" style="background: linear-gradient(rgba(18, 20, 22, 0.80), rgba(18, 20, 22, 0.80)), url('${O}') center/cover no-repeat;">
            <div class="split-content">
                <h2>PRAHA 3</h2>
                <div class="info-table">
                    <div class="info-row">
    ...
    `,A=`/duo_cafe/assets/breakfast1-CCMa6iCo.jpg`,j=`/duo_cafe/assets/breakfast2-BHyXAAKk.jpg`,M=`/duo_cafe/assets/coffee-B1e2qna6.jpg`,N=`/duo_cafe/assets/desserts-jcL5YtJk.jpg`,P=`/duo_cafe/assets/hot-cold-drinks-BNyWPw4k.jpg`,F=`/duo_cafe/assets/pasta1-DF6DmOcv.jpg`,I=`/duo_cafe/assets/pasta2-BZMAP7QE.jpg`,L=`/duo_cafe/assets/salads-CFEbGa0F.jpg`,R=`/duo_cafe/assets/soups-CZ_XYrJE.jpg`,z=`/duo_cafe/assets/pizza1-DnB0wuAZ.jpg`,B=`/duo_cafe/assets/pizza2-CcKfxzin.jpg`,V=e=>`
    <div class="menu-page dark-tech-theme">
        ...
        <div class="menu-container">
            ...
            <section class="menu-section fade-in-up">
                ...
                <div class="menu-image-card"><img src="${A}" alt="Snídaně 1"></div>
                <div class="menu-image-card"><img src="${j}" alt="Snídaně 2"></div>
            </section>

            <!-- Кофе -->
            <section class="menu-section fade-in-up">
                <h2 class="section-title">${e(`menu_coffee`)}</h2>
                <div class="menu-image-card"><img src="${M}" alt="Káva"></div>
            </section>

            <!-- Десерты -->
            <section class="menu-section fade-in-up">
                <h2 class="section-title">${e(`menu_desserts`)}</h2>
                <div class="menu-image-card"><img src="${N}" alt="Dezerty"></div>
            </section>

            <!-- Напитки -->
            <section class="menu-section fade-in-up">
                <h2 class="section-title">${e(`menu_drinks`)}</h2>
                <div class="menu-image-card"><img src="${P}" alt="Nápoje"></div>
            </section>

            <!-- Паста -->
            <section class="menu-section fade-in-up">
                <h2 class="section-title">${e(`menu_pasta`)}</h2>
                <div class="menu-image-card"><img src="${F}" alt="Pasta 1"></div>
                <div class="menu-image-card"><img src="${I}" alt="Pasta 2"></div>
            </section>

            <!-- Салаты -->
            <section class="menu-section fade-in-up">
                <h2 class="section-title">${e(`menu_salads`)}</h2>
                <div class="menu-image-card"><img src="${L}" alt="Saláty"></div>
            </section>

            <!-- Супы -->
            <section class="menu-section fade-in-up">
                <h2 class="section-title">${e(`menu_soups`)}</h2>
                <div class="menu-image-card"><img src="${R}" alt="Polévky"></div>
            </section>
            ...
            <section class="menu-section fade-in-up pizza-section" id="pizza-section">
                ...
                <div class="menu-image-card"><img src="${z}" alt="Pizza 1"></div>
                <div class="menu-image-card"><img src="${B}" alt="Pizza 2"></div>
            </section>
        </div>
    </div>
    `,H=e=>`
    ...
    `,U=`/duo_cafe/assets/coffee2-DEi4WC9A.png`,W=e=>(setTimeout(()=>{let e=document.querySelector(`.about_text`);e&&G.observe(e)},100),setTimeout(()=>{let e=document.querySelector(`.reviews`);e&&K.observe(e)},100),`
<div class="home">
        <div class="home1"> 
            <img src="${U}" alt="Coffee">
        </div>        
        <div class="span1">
            <b>${e(`perfect_brew`)}</b>
        </div>
