var e=Object.create,t=Object.defineProperty,n=Object.getOwnPropertyDescriptor,r=Object.getOwnPropertyNames,i=Object.getPrototypeOf,a=Object.prototype.hasOwnProperty,o=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),s=(e,i,o,s)=>{if(i&&typeof i==`object`||typeof i==`function`)for(var c=r(i),l=0,u=c.length,d;l<u;l++)d=c[l],!a.call(e,d)&&d!==o&&t(e,d,{get:(e=>i[e]).bind(null,d),enumerable:!(s=n(i,d))||s.enumerable});return e},c=(n,r,a)=>(a=n==null?{}:e(i(n)),s(r||!n||!n.__esModule?t(a,`default`,{value:n,enumerable:!0}):a,n));(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var l=(e,t)=>`
    ...
    `,D=()=>`
    Contacts Page
    `,O=`/duo_cafe/assets/breakfast1-CCMa6iCo.jpg`,k=`/duo_cafe/assets/breakfast2-BHyXAAKk.jpg`,A=`/duo_cafe/assets/coffee-B1e2qna6.jpg`,j=`/duo_cafe/assets/desserts-jcL5YtJk.jpg`,M=`/duo_cafe/assets/hot-cold-drinks-BNyWPw4k.jpg`,N=`/duo_cafe/assets/pasta1-DF6DmOcv.jpg`,P=`/duo_cafe/assets/pasta2-BZMAP7QE.jpg`,F=`/duo_cafe/assets/salads-CFEbGa0F.jpg`,I=`/duo_cafe/assets/soups-CZ_XYrJE.jpg`,L=`/duo_cafe/assets/pizza1-DnB0wuAZ.jpg`,R=`/duo_cafe/assets/pizza2-CcKfxzin.jpg`,z=e=>`
    <div class="menu-page dark-tech-theme">
        ...
        <div class="menu-container">
            ...
            <section class="menu-section fade-in-up">
                ...
                <div class="menu-image-card"><img src="${O}" alt="Snídaně 1"></div>
                <div class="menu-image-card"><img src="${k}" alt="Snídaně 2"></div>
            </section>

            <!-- Кофе -->
            <section class="menu-section fade-in-up">
                <h2 class="section-title">${e(`menu_coffee`)}</h2>
                <div class="menu-image-card"><img src="${A}" alt="Káva"></div>
            </section>

            <!-- Десерты -->
            <section class="menu-section fade-in-up">
                <h2 class="section-title">${e(`menu_desserts`)}</h2>
                <div class="menu-image-card"><img src="${j}" alt="Dezerty"></div>
            </section>

            <!-- Напитки -->
            <section class="menu-section fade-in-up">
                <h2 class="section-title">${e(`menu_drinks`)}</h2>
                <div class="menu-image-card"><img src="${M}" alt="Nápoje"></div>
            </section>

            <!-- Паста -->
            <section class="menu-section fade-in-up">
                <h2 class="section-title">${e(`menu_pasta`)}</h2>
                <div class="menu-image-card"><img src="${N}" alt="Pasta 1"></div>
                <div class="menu-image-card"><img src="${P}" alt="Pasta 2"></div>
            </section>

            <!-- Салаты -->
            <section class="menu-section fade-in-up">
                <h2 class="section-title">${e(`menu_salads`)}</h2>
                <div class="menu-image-card"><img src="${F}" alt="Saláty"></div>
            </section>

            <!-- Супы -->
            <section class="menu-section fade-in-up">
                <h2 class="section-title">${e(`menu_soups`)}</h2>
                <div class="menu-image-card"><img src="${I}" alt="Polévky"></div>
            </section>
            ...
            <section class="menu-section fade-in-up pizza-section" id="pizza-section">
                ...
                <div class="menu-image-card"><img src="${L}" alt="Pizza 1"></div>
                <div class="menu-image-card"><img src="${R}" alt="Pizza 2"></div>
            </section>
        </div>
    </div>
    `,B=e=>`
    ...
    `,V=`/duo_cafe/assets/coffee2-DEi4WC9A.png`,H=e=>(setTimeout(()=>{let e=document.querySelector(`.about_text`);e&&U.observe(e)},100),setTimeout(()=>{let e=document.querySelector(`.reviews`);e&&W.observe(e)},100),`
<div class="home">
        <div class="home1"> 
            <img src="${V}" alt="Coffee">
        </div>        
        <div class="span1">
            <b>${e(`perfect_brew`)}</b>
        </div>
